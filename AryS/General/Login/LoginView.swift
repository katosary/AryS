...
struct LoginView: View {
    ...
    // 新規登録画面・店舗ログイン画面を表示するためのフラグ
    @State private var isShowingSignUp = false
    @State private var isShowingStoreLogin = false
    ...
    var body: some View {
                ...
                ScrollView {
                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 16) {
                            ...
                            // 店舗ログインへの切り替えボタン
                            Button {
                                isShowingStoreLogin = true
                            } label: {
                                Text("店舗オーナーの方はこちら（店舗ログイン）")
                                    .font(.footnote)
                                    .foregroundColor(.white.opacity(0.9))
                                    .underline()
                            }
        ...
        .fullScreenCover(isPresented: $isShowingStoreLogin) {
            StoreLoginView()
        }
    }
}
